...
struct GlassTabBar: View {
                    ...
                    .background(alignment: .leading) {
                        if isGlassAvailable {
                            ...
                            ZStack {
                                ...
                                Color.clear
                                    .clippedWithBackgroundMaterial(in: .capsule, showShadow: true)
                            }
                            .compositingGroup()
                            .frame(width: tabItemWidth, height: tabItemHeight)
    ...
    private func TabItemView(_ tab: TabBarItem, width: CGFloat, height: CGFloat) -> some View {
        ...
        VStack(spacing: 4) {
            (activeTab == tab ? tab.imageSelected : tab.image)
                .resizable()
                .scaledToFit()
        ...
        .foregroundStyle(activeTab == tab ? colorManager.tintColor : Color(.label))
...
#Preview {
    @Previewable @State var activeTab: TabBarItem = .study
